...
internal class EditorState {
    val widgets = mutableStateListOf<GridItem>(
        GridItem(id = "A", row = 0, col = 0, spanX = 2, spanY = 2),
        GridItem(id = "B", row = 0, col = 2, spanX = 1, spanY = 1),
        GridItem(id = "C", row = 3, col = 1, spanX = 2, spanY = 1),
        GridItem(id = "D", row = 2, col = 0, spanX = 1, spanY = 2)
    )
    ...
    fun getWidget(id: String): GridItem? = widgets.find { it.id == id }
}
